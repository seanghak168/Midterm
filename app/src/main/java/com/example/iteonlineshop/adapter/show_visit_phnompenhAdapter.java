...
public class show_visit_phnompenhAdapter extends ListAdapter<PhnomPenh, show_visit_phnompenhAdapter.PostsViewHolder> {
    public show_visit_phnompenhAdapter() {
    ...
    protected static class PostsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(PhnomPenh culture){
